...
contract PartyPanda is ERC4883, Colours, ERC721Holder {
    ...
    function _generateSVGBody(uint256 tokenId) internal view virtual override returns (string memory) {
        ...
        return string.concat(
            ...
            '<g stroke="black" stroke-width="8" stroke-linecap="round" stroke-linejoin="round">' '<g fill="',
            colourValue,
            '">'
            ...
            '<path d="M166.371 134.71C159.627 93.6161 168.829 83.778 208.586 96.0128L166.371 134.71Z"/>' "</g>" '<g fill="snow">'
            ...
            '<path d="M182.788 416.142L172.234 319.986H305.915V425.523C267.207 438.31 226.501 448.015 182.788 416.142Z"/>' "</g>"
            '<g fill="',
            colourValue,
            '">'
            ...
            '<path d="M221.485 228.521C242.829 237.607 245.499 236.723 263.7 228.521"/>' "</g>"
