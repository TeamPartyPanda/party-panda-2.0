...
contract PartyPanda is ERC4883, Colours, ERC721Holder {
    ...
    constructor()
        ERC4883("Party Panda 2.0", "PP2", 0.000888 ether, 0xeB10511109053787b3ED6cc02d5Cb67A265806cC, 175, 999)
    {}
    ...
    function _generateSVGBody(uint256 tokenId) internal view virtual override returns (string memory) {
        ...
        return string.concat(
            ...
            '">' "<desc>Party Panda is Copyright 2022 by Alex Party Panda https://github.com/AlexPartyPanda</desc>" '<g fill="',
            colourValue,
            '">'
            ...
            '<path d="M203.895 438.422C188.866 441.956 126.168 466.883 112.43 429.041C113.412 402.012 115.628 378.479 120.983 355.165C128.972 320.386 143.947 286.097 172.234 241.42C237.262 281.898 267.857 272.611 332.885 242.592C361.052 282.666 377.85 317.581 377.663 346.957C377.6 356.842 380.012 367.162 377.663 378.618C377.663 378.618 373.927 400.898 373.927 429.041C373.927 457.185 297.706 465.393 289.498 429.041C281.289 392.69 286.505 410.486 297.706 346.957C263.52 339.96 240.669 340.596 195.687 346.957C202.359 358.413 218.925 434.889 203.895 438.422Z" fill="',
            colourValue,
            '" stroke="black" stroke-width="7.62162" stroke-linecap="round" stroke-linejoin="round"/>'
            '<path d="M294.188 133.537C278.558 140.565 272.033 146.383 264.872 160.508C283.729 170.948 293.316 180.152 308.26 203.895L321.159 186.306C315.382 159.43 310.699 146.264 294.188 133.537Z" fill="',
            colourValue,
            '" stroke="black" stroke-width="7.62162" stroke-linecap="round" stroke-linejoin="round"/>'
            '<path d="M207.241 139.228C219.2 152.324 213.673 152.092 217.794 160.335C206.104 161.8 197.052 169.693 176.752 195.514C174.004 187.729 173.302 187.34 169.716 175.579C166.131 163.819 195.281 126.131 207.241 139.228Z" fill="',
            colourValue,
            '" stroke="black" stroke-width="7.62162" stroke-linecap="round" stroke-linejoin="round"/>'
